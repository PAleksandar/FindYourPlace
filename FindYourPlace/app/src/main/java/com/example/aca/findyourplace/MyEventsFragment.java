...
public class MyEventsFragment extends Fragment implements SearchView.OnQueryTextListener{
    ...
    @SuppressLint("ValidFragment")
    public MyEventsFragment(int userId)
    {
        this.userId=userId;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView=view.findViewById(R.id.recycler_view_myEvents);
                    ...
                    @Override public void onItemClick(View view, int position) {
                        ...
                        builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Event e=eventList.remove(position);
    ...
    {
        eventList.addAll(Event.loadEvents(userId));
